...
PV_INIT_GPIO:
	...
	// enable GPIO | IOCON | RTC | PINT | SRAM1+SRAM2 | USART0
	OR LPC_SYSAHBCLKCTRL, (1<<6) | (1<<16) | (1<<30) | (1<<19) | (3<<26) | (1<<12)
        AND LPC_RTCCTRL, ~1
        SET LPC_RTCCTRL, (1<<7)
...
// end SPI.cpp
	...
	// GPIO_DIR[2]:
	SET LPC_GPIO_PORT_DIR2, 0x0007FFF8  // was SET LPC_GPIO_PORT_DIR2, 0x0007FFFC
	...
	LCD_CMD 0x01, 0x01C, 9  // was LCD_CMD 0x01, 0x11C, 9
